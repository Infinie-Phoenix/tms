...
try:
    ...
    os.system('python Nikesh.py')
	
os.system('xdg-open https://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E')
...
██   ████ ██ ██   ██ ███████ ███████ ██   ██ 
                                             ...
                                             {BLUE}X {RED}Timalsina{WHITE}

\t[×] Developed By Nikesh x Timalsina{EXTRA} (NT)
{WHITE}[•] AUTHOR       : Nikesh X Timalsina 
{WHITE}[•] STATUS         :  FREE
{WHITE}[•] WhatsApp     :   +9779806878387
[•] FaceBook     :   Nikesh Timalsina
[•] Version      :   {RED}13.13

{WHITE}================================================
   \33[37;41m\t Nikesh x Timalsina  x NT \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [NikeshI-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
